...
<div class="modal fade" id="update_subject" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" method="post" action="update_subject.php">
          ...
          <div class="form-group">
            <div class="col-sm-offset-10 col-sm-2">
              <button name="update_subject" type="submit" class="btn btn-success">Add</button>
            </div>
          </div>
        </form>
      </div>
